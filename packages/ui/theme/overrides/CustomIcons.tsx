...
// Close
export const CloseIcon = <AppIcon icon={closeFilled} />;

// Alert
export const ErrorIcon = <AppIcon icon={warningIcon} />;
export const InfoIcon = <AppIcon icon={informationIcon} />;
export const SuccessIcon = <AppIcon icon={checkmarkOutline} />;
export const WarningIcon = <AppIcon icon={warningAlt} />;

// Using for Rating
export const StarIcon: FC<{ sx?: CSSProperties }> = (props) => {
    return (
        <SvgIcon {...props}>
...
// Using for Checkbox
export const CheckboxIcon: FC<{ sx?: CSSProperties }> = (props) => {
    return (
        <SvgIcon {...props}>
...
export const CheckboxCheckedIcon: FC<{ sx?: CSSProperties }> = (props) => {
    return (
        <SvgIcon {...props}>
...
export const CheckboxIndeterminateIcon: FC<{ sx?: CSSProperties }> = (
    props
) => {
    return (
        <SvgIcon {...props}>
...
export const RadioIcon: FC<{ sx?: CSSProperties }> = (props) => {
    return (
        <SvgIcon {...props}>
...
export const RadioCheckedIcon: FC<{ sx?: CSSProperties }> = (props) => {
    return (
        <SvgIcon {...props}>
...
export const InputSelectIcon: FC<{ sx?: CSSProperties }> = (props) => {
    return (
        <SvgIcon
            {...props}
            sx={{
...
export const AutocompleteIcon: FC<{ sx?: CSSProperties }> = (props) => {
    return (
...
//  Using for TreeView
export const TreeViewCollapseIcon: FC<{ sx?: CSSProperties }> = (props) => {
    return (
        <SvgIcon {...props}>
...
export const TreeViewExpandIcon: FC<{ sx?: CSSProperties }> = (props) => {
    return (
        <SvgIcon {...props}>
...
export const TreeViewEndIcon: FC<{ sx?: CSSProperties }> = (props) => {
    return (
        <SvgIcon {...props}>
